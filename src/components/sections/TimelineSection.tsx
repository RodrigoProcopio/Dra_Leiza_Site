...
export default function TimelineSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-white">
      ...
      {/* Foto da Dra. Leiza como background opaco — lado direito */}
      <div
        className="pointer-events-none absolute inset-y-0 right-0 w-1/2 md:w-2/5"
        style={{ opacity: 0.08 }}
      >
        <img
        ...
        />
        {/* Fade nas bordas para integrar com o fundo */}
          ...
          {(["all", ...ALL_CATEGORIES] as const).map((cat) => {
            ...
            return (
              <button
                ...
                style={{
                  background: isActive ? "#0B1B3A" : "rgba(255,255,255,0.75)",
